...
ALTER COLUMN patient_number SET DEFAULT nextval('patient_number_seq');
...
-- Drop old foreign key constraints and columns, add new ones
ALTER TABLE public.patient_treatments 
DROP COLUMN patient_id,
RENAME COLUMN new_patient_id TO patient_id;
...
-- follow_up_records patient_id can remain nullable for now
